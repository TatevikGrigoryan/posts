...
<div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-center">
    ...
    <div class="row">
        <div class="row font-semibold text-center my-4 justify-center"> Posts</div>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary">
                            <a class="dropdown-item" href="{{ route('post', ['post_id' => $item['id']]) }}">
                                {{ __('Read more') }}
                            </a>
                        </button>
                    </td>
        ...
        @auth
            <button class="btn btn-primary">
                <a class="dropdown-item" href="{{ route('add_post') }}">
                    {{ __('Add post') }}
                </a>
            </button>
        @endauth
